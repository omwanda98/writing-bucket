...
import essaywrite from '../Assets/Rectangle65.jpg';
    ...
    return (
        <div className="book-review-container">
            <div className="header-section">
                <h1>Write my Custome Essay for me</h1>
                <p>
                Assignments are there throughout high schools and colleges. However, you may have some other responsibilities to tend to or you may not have grasped the topic properly. In this case, it is always good to get an expert in the subject matter who can help you and relieve you of your stress. writing-bucket.com is here to offer you the help that you need in your homework.
                </p>
                ...
                <div className="section">
                    <div className="section-content">
                        ...
                        <div className="text-container">
                            <h3>Why should you choose writing-bucket.com for your essay?</h3>
                            <p>
